...
{
	public World7(Renderer renderer) 
	{
		super(renderer);
	}
	...
	public void loadSimulation() 
	{
		...
		int xPlatforms = 4;
		int zPlatforms = 4;
		double platformLength = 30;
		double platformWidth =30;
		
		double platformY = -8;
		
		for(double platformX = -xPlatforms/2*platformLength; platformX < xPlatforms/2*platformLength; platformX += platformLength*1.5 )
			for(double platformZ = -zPlatforms/2*platformWidth; platformZ < zPlatforms/2*platformWidth; platformZ += platformWidth*1.5 )
			{
		...
		{
			defaultData[i].color_shadow_highligt[0] = 0;
			defaultData[i].color_shadow_highligt[1] = 1f;
			defaultData[i].color_shadow_highligt[2] = 0;
			
			defaultData[i].color_lit_highligt[0] = 0;
			defaultData[i].color_lit_highligt[1] = 0;
			defaultData[i].color_lit_highligt[2] = 0;
	
	
			defaultData[i].color_lit_solid[0] = .0f;
			defaultData[i].color_lit_solid[1] = .55f;
			defaultData[i].color_lit_solid[2] = .0f;
	
			defaultData[i].color_shadow_solid[0] = 0f;
			defaultData[i].color_shadow_solid[1] = .25f;
			defaultData[i].color_shadow_solid[2] = 0f;
			defaultData[i].color_shadow_solid[3] = 1f;
		}
		//////////////////////////////////
		//////////////////////////////////
		//////////////////////////////////
		...
		defaultData[playerIndex].color_lit_highligt[0] = 0;
		defaultData[playerIndex].color_lit_highligt[1] = 0;
		defaultData[playerIndex].color_lit_highligt[2] = 0;
		defaultData[playerIndex].color_lit_highligt[3] = 1.0f;

		defaultData[playerIndex].color_shadow_highligt[0] = 0;
		defaultData[playerIndex].color_shadow_highligt[1] = 0;
		defaultData[playerIndex].color_shadow_highligt[2] = 0;
		defaultData[playerIndex].color_shadow_highligt[3] = 1.0f;

		defaultData[playerIndex].color_lit_solid[0] = 0.55f;
		defaultData[playerIndex].color_lit_solid[1] = 0.0f;
		defaultData[playerIndex].color_lit_solid[2] = 0.0f;
		defaultData[playerIndex].color_lit_solid[3] = 1.0f;
		
		defaultData[playerIndex].color_shadow_solid[0] = 0.25f;
		defaultData[playerIndex].color_shadow_solid[1] = 0.0f;
		defaultData[playerIndex].color_shadow_solid[2] = 0.0f;
		defaultData[playerIndex].color_shadow_solid[3] = 1.0f;
...
//		defaultData = Math3D.push_back(sphere, defaultData);
	...
	int numTrees = 4;
	int treesStartIndex = 0;
	
	private void loadTrees() 
	{
		treesStartIndex = objects.length;
		...
		for(int i = 0; i < numTrees; i ++)
		{
			...
			defaultData[objects.length-1].infiniteMass = true;
			defaultData[objects.length-2].infiniteMass = true;

//			defaultData[objects.length-1].color_shadow_solid[3] = 0;
//			defaultData[objects.length-2].color_shadow_solid[3] = 0;
...
//				return (float) (function_height*Math.cos(function_length*Math.sqrt((x)*(x)+(z)*(z))));
	...
	void loadTree(int slices, double trunkRadius, double canopyRadius, double trunkHeight, double canopyHeight, double x, double y, double z)
	{
		...
		canopy.displacement[1] = y+trunkHeight*.75;
