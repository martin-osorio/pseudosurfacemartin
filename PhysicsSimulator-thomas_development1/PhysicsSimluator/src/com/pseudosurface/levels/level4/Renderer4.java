...
public class Renderer4 extends Renderer{

	TextureQuad galaxy;
	
	public Renderer4(SimulatorActivity simulation) {
		super(simulation);
	...
	public void preliminaryRendering(float[] modelMatrix, float[] viewMatrix, float[] projectionMatrix) 
	{
        ...
        GLES20.glUniform1i(((Shader4)shader).isGalaxyHandle, 1); 
        ...
        GLES20.glUniform1i(((Shader4)shader).isGalaxyHandle, 0);
