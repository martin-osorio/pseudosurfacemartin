...
public class Renderer8 extends Renderer{

	TextureQuad galaxy;
	
	public Renderer8(SimulatorActivity simulation) {
		super(simulation);
	...
	public void preliminaryRendering(float[] modelMatrix, float[] viewMatrix, float[] projectionMatrix) 
	{
        ...
        GLES20.glUniform1i(((Shader8)shader).isGalaxyHandle, 1); 
        ...
        GLES20.glUniform1i(((Shader8)shader).isGalaxyHandle, 0);
