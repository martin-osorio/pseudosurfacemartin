...
//		}
	...
	{	
		for(int i = 0; i < objects.length; i++)
		{
			if(objects[i].surfaces.length == 0 || 
				Math3D.distance(objects[i].displacement, objects[getPlayerIndex()].displacement) < maxDrawDistance+objects[i].surfaces[0].maxRadius)
			{
