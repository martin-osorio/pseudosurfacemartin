...
//Description: Helper math class that uses quaternions to generate rotation matrices.
//Date Created: January 1rst 2008
//Author: Ian Wesson
...
public class Quaternion 
{
	...
	{
	    cos_a = Math.cos( angle / 2.0f );
	    sin_a = Math.sin( angle / 2.0f );
	...
	{
		mag = Math.sqrt(omegaX*omegaX + omegaY*omegaY + omegaZ*omegaZ); 
