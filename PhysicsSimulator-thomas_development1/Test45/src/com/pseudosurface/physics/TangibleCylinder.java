...
public class TangibleCylinder extends TangibleObject
{
	...
	public TangibleCylinder(int slices, double cylinderRadius, double cylinderHeight)
	{
		super();

		this.cylinderRadius = (float) cylinderRadius;
		this.cylinderHeight = (float) cylinderHeight;

		color_lit_highligt[0] = .33f*1.5f;
		color_lit_highligt[1] = .16f*1.5f;
		color_lit_highligt[2] = 0;
		color_lit_highligt[3] = 1;
		
		color_shadow_highligt[0] = .66f*1.5f;
		color_shadow_highligt[1] = .32f*1.5f;
		color_shadow_highligt[2] = 0;
		color_shadow_highligt[3] = 1;

		color_lit_solid[0] = .33f;
		color_lit_solid[1] = .16f;
		color_lit_solid[2] = 0f;
		color_lit_solid[3] = 1f;

		color_shadow_solid[0] = .33f/2.0f;
		color_shadow_solid[1] = .16f/2.0f;
		color_shadow_solid[2] = 0.0f;
		color_shadow_solid[3] = 1.0f;
		
		ConvexSurface surface;

		surface = Shapes.loadCylinder(slices, cylinderHeight, cylinderRadius);
    ...
    void reloadVerts()
    {
        ...
        edgeVertexBuffer.put(trunk_edgeVertices);
        ...
        // add the coordinates to the FloatBuffer
        triangleVertexBuffer.put(trunk_triangleVertices);
        // set the buffer to read the first coordinate
        ...
        // add the coordinates to the FloatBuffer
        normalVertexBuffer.put(trunk_normalVertices);
        // set the buffer to read the first coordinate
	...
	public void draw(float[] modelMatrix, float[] viewMatrix, float[] projectionMatrix) {
        ...
        GLES20.glVertexAttribPointer(Renderer.shader.mPositionHandle, COORDS_PER_VERTEX,
                                     ...
                                     trunk_triangleVertexStride, triangleVertexBuffer);        	
        ...
        GLES20.glVertexAttribPointer(Renderer.shader.mNormalHandle, COORDS_PER_VERTEX,
                                     GLES20.GL_FLOAT, false,
                                     trunk_normalVertexStride, normalVertexBuffer);
        ...
        GLES20.glVertexAttribPointer(Renderer.shader.mPositionHandle, COORDS_PER_VERTEX,
                                     GLES20.GL_FLOAT, false,
                                     trunk_edgeVertexStride, edgeVertexBuffer);
