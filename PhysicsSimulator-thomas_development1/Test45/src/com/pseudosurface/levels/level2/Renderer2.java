...
public class Renderer2 extends Renderer{

	TextureQuad galaxy;
	
	public Renderer2(SimulatorActivity simulation) {
		super(simulation);
	...
	public void preliminaryRendering(float[] modelMatrix, float[] viewMatrix, float[] projectionMatrix) 
	{
        ...
        GLES20.glUniform1i(((Shader2)shader).isGalaxyHandle, 1); 
        ...
        GLES20.glUniform1i(((Shader2)shader).isGalaxyHandle, 0);
