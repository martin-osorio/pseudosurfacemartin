...
{
	public World4(Renderer renderer) 
	{
		super(renderer);
	}
...
//		defaultData = Math3D.push_back(sphere, defaultData);
	...
	private void loadRoad() {
		...
		loadPlatform(platformX, -15, platformZ, platformLength, platformWidth, platformLength, platformWidth/2);
	...
	class Curve extends XZEquation{
		...
		{
			return u-10*Math.sin(function_length*Math.sqrt((v)*(v)));
		}
