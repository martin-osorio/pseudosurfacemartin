...
public class Renderer3 extends Renderer{

	TextureQuad galaxy;
	
	public Renderer3(SimulatorActivity simulation) {
		super(simulation);
	...
	public void preliminaryRendering(float[] modelMatrix, float[] viewMatrix, float[] projectionMatrix) 
	{
        ...
        GLES20.glUniform1i(((Shader3)shader).isGalaxyHandle, 1); 
        ...
        GLES20.glUniform1i(((Shader3)shader).isGalaxyHandle, 0);
