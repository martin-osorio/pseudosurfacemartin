...
public class Renderer7 extends Renderer{

//	TextureQuad galaxy;
	
	
	
	public Renderer7(SimulatorActivity simulation) {
		super(simulation);
		starbox = new Stars(750, true);
...
//        GLES20.glUniform1i(((Shader7)shader).isGalaxyHandle, 1); 
...
//        GLES20.glUniform1i(((Shader7)shader).isGalaxyHandle, 0);
